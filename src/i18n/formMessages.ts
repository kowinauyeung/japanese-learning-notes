const en = {
  ...
  'import.promptLabel': 'Prompt',
  'import.schema': 'View JSON schema',
  'import.paste': 'Paste from clipboard',
  'import.pasteError':
    'Could not read the clipboard. Paste into the box below with your keyboard or a long press.',
...
const ja: FormMessages = {
  ...
  'import.promptLabel': 'プロンプト',
  'import.schema': 'JSON スキーマを見る',
  'import.paste': 'クリップボードから貼り付け',
  'import.pasteError':
    'クリップボードを読み取れませんでした。下の欄にキーボードまたは長押しで貼り付けてください。',
...
const zhHant: FormMessages = {
  ...
  'import.paste': '從剪貼簿貼上',
  'import.pasteError': '無法讀取剪貼簿。請用鍵盤或長按，直接貼到下面的欄位。',
...
const ko: FormMessages = {
  ...
  'import.promptLabel': '프롬프트',
  'import.schema': 'JSON 스키마 보기',
  'import.paste': '클립보드에서 붙여넣기',
  'import.pasteError': '클립보드를 읽지 못했습니다. 아래 칸에 키보드나 길게 누르기로 붙여넣으세요.',
...
const es: FormMessages = {
  ...
  'import.paste': 'Pegar del portapapeles',
  'import.pasteError':
    'No se pudo leer el portapapeles. Pega en el cuadro de abajo con el teclado o una pulsación larga.',
