...
import { BottomNotices } from './components/BottomNotices';
  ...
  <StrictMode>
    <AuthProvider>
      <AppUpdateProvider port={appUpdatePort}>
        <I18nProvider>
          {/*
            Outside the router, because a waiting build and a dropped
            connection are facts about the tab and not about the route: a
            reader sitting on /login or /privacy is just as stuck on the old
            build, and just as offline, as one mid-practice.
            ...
            is the worse half of the trade for a handful of short strings.
          */}
          <BottomNotices />
