  ...
  en: {
    ...
    features: {
      ...
      list: [
        ...
        'Use history and the dashboard to see when, what and how much you studied.',
  ...
  ko: {
    ...
    features: {
      ...
      list: [
        ...
        '학습 기록과 대시보드에서 언제 무엇을 얼마나 공부했는지 확인할 수 있습니다.',
  ...
  es: {
    ...
    features: {
      ...
      list: [
        ...
        'Consulta cuándo, qué y cuánto estudiaste en el historial y el panel.',
